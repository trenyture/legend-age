<template>
	<main class="root-container">
		...
		<section class="product">
			...
			<p>Sur du long terme, ce type de produits peuvent provoquer, des gerçures, le vieillissement prématuré des lèvres, un empoisonnement au mercure ou au plomb en rendant les lèvres ternes ou décolorées etc...</p>
			...
			<p>Grâce à ces différents ingrédients actifs naturels, le baume à lèvres Legend Age est un baume sain avec un véritable effet de régénération de la peau et de protection contre les UV.</p>
			<p>C’est un produit cosmétique pour les lèvres qui a reçu diverses récompenses de l’industrie de la beauté, de la mode ainsi que par les administrations gouvernementales des pays où il est commercialisé.</p>
		</section>
	</main>
</template>

<script src="./Root.js"></script>
<style lang="scss">@import "./Root.scss";</style>