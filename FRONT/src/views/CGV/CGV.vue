<template>
	<main class="conditions-container">
		<h2>Conditions générales de vente des produits vendus sur Soins des Levres</h2>
		<p>
			Legend Age
			<br>Siège social Place Pey Berland 33000 Bordeaux
			<br>Adresse du courrier électronique francelegendage@gmail.com
			<br>Le responsable de la publication personne physique est Yabin Liu>
			<br>Date de dernière mise à jour <b>30 Octobre 2019</b>
		</p>
		<h3>Article 1 - Objet</h3>

		<p>Les présentes conditions régissent les ventes par la société Legend Age Place Pey Berland 33000 Bordeaux de produits de beauté.</p>
		...
		<p>En cas de commande vers un pays autre que la France métropolitaine vous êtes l'importateur du ou des produits concernés. Des droits de douane ou autres taxes locales ou droits d'importation ou taxes d'état sont susceptibles d'être exigibles. Ces droits et sommes ne relèvent pas du ressort de la société <b>Legend Age</b>. Ils seront à votre charge et relèvent de votre entière responsabilité, tant en termes de déclarations que de paiements aux autorités et organismes compétents de votre pays. Nous vous conseillons de vous renseigner sur ces aspects auprès de vos autorités locales.</p>

		<p>Toutes les commandes quelle que soit leur origine sont payables en euros. </p>

		<p>La société <b>Legend Age</b> se réserve le droit de modifier ses prix à tout moment, mais le produit sera facturé sur la base du tarif en vigueur au moment de la validation de la commande et sous réserve de disponibilité.</p>

		<p>Les produits demeurent la propriété de la société <b>Legend Age</b> jusqu'au paiement complet du prix. </p>
		...
		<p>Sur Internet : <a href="https://soins-des-levres.fr">https://soins-des-levres.fr</a></p>
		...
		<p>La société <b>Legend Age</b> se réserve le droit de ne pas enregistrer un paiement, et de ne pas confirmer une commande pour quelque raison que ce soit, et plus particulièrement en cas de problème d'approvisionnement, ou en cas de difficulté concernant la commande reçue.</p>

		<h3>Article 4 - Validation de votre commande</h3>

		<p>Toute commande figurant sur le site Internet <a href="https://soins-des-levres.fr">https://soins-des-levres.fr</a> suppose l'adhésion aux présentes Conditions Générales. Toute confirmation de commande entraîne votre adhésion pleine et entière aux présentes conditions générales de vente, sans exception ni réserve. </p>
		...
		<p>Le règlement de vos achats s'effectue par carte bancaire grâce au système sécurisé Stripe.</p>
		...
		<p>En cas d'exercice du droit de rétractation, la société <b>Legend Age</b> procédera au remboursement des sommes versées, dans un délai de 14 jours suivant la notification de votre demande et via le même moyen de paiement que celui utilisé lors de la commande.</p>
		...
		<p>Nos produits sont proposés tant qu'ils sont visibles sur le site <a href="https://soins-des-levres.fr">https://soins-des-levres.fr</a> et dans la limite des stocks disponibles. Pour les produits non stockés, nos offres sont valables sous réserve de disponibilité chez nos fournisseurs.</p>
		...
		<p>En outre, le site Internet <a href="https://soins-des-levres.fr">https://soins-des-levres.fr</a> n'a pas vocation à vendre ses produits en quantités importantes. Par conséquent la société <b>Legend Age</b> se réserve le droit de refuser les commandes de  articles identiques.</p>
		...
		<p>En cas de livraisons par une transporteur, la société <b>Legend Age</b> ne peut être tenue pour responsable de retard de livraison dû exclusivement à une indisponibilité du client après plusieurs propositions de rendez-vous.</p>
		...
		<p>Les produits proposés sont conformes à la législation française en vigueur. La responsabilité de la société <b>Legend Age</b> ne saurait être engagée en cas de non-respect de la législation du pays où le produit est livré. Il vous appartient de vérifier auprès des autorités locales les possibilités d'importation ou d'utilisation des produits ou services que vous envisagez de commander.</p>

		<p>Par ailleurs, la société <b>Legend Age</b> ne saurait être tenue pour responsable des dommages résultant d'une mauvaise utilisation du produit acheté.</p>

		<p>Enfin la responsabilité de la société <b>Legend Age</b> ne saurait être engagée pour tous les inconvénients ou dommages inhérents à l'utilisation du réseau Internet, notamment une rupture de service, une intrusion extérieure ou la présence de virus informatiques.</p>

		<h3>Article 11 - Droit applicable en cas de litiges</h3>
		...
		<p>Tous les éléments du site <a href="https://soins-des-levres.fr">https://soins-des-levres.fr</a> sont et restent la propriété intellectuelle et exclusive de la société <b>Legend Age</b>. Nul n'est autorisé à reproduire, exploiter, rediffuser, ou utiliser à quelque titre que ce soit, même partiellement, des éléments du site qu'ils soient logiciels, visuels ou sonores. Tout lien simple ou par hypertexte est strictement interdit sans un accord écrit exprès de la société <b>Legend Age</b>. </p>

		<p>Article 13 - Données personnelles</p>

		<p>La société <b>Legend Age</b> se réserve le droit de collecter les informations nominatives et les données personnelles vous concernant. Elles sont nécessaires à la gestion de votre commande, ainsi qu'à l'amélioration des services et des informations que nous vous adressons. </p>
		...
		<h3>Article 14 - Archivage Preuve</h3>

		<p>La société <b>Legend Age</b> archivera les bons de commandes et les factures sur un support fiable et durable constituant une copie fidèle conformément aux dispositions de l'article 1348 du Code civil. </p>

		<p>Les registres informatisés de la société <b>Legend Age</b> seront considérés par toutes les parties concernées comme preuve des communications, commandes, paiements et transactions intervenus entre les parties.</p>
	</main>
</template>

<style lang="scss">@import "./CGV.scss";</style>
