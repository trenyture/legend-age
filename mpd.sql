 ...
 * TABLES ASSOCIATIVES
 */
DROP TABLE IF EXISTS at_command_address;
CREATE TABLE IF NOT EXISTS at_command_address(
	fk_command INT UNSIGNED NOT NULL,
	fk_address INT UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS at_command_user;
CREATE TABLE IF NOT EXISTS at_command_user(
	fk_command INT UNSIGNED NOT NULL,
	fk_user INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS comment(
	...
	firstname VARCHAR(128) NOT NULL,
	lastname VARCHAR(128) NOT NULL,
	notation INT(1) UNSIGNED NOT NULL,
	message TEXT NOT NULL,
	created_date TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
